...
<div class="w3-black">
    ...
    <div style="color:black">
      <nav class="w3-sidebar w3-bar-block w3-small w3-hide-small w3-center">
        ...
        <a href="http://localhost/PortX/MainUI.html" class="w3-bar-item w3-button w3-padding-large w3-hover-black">
        ...
        <a href="http://localhost/PortX/User/UserMainUi.html" class="w3-bar-item w3-button w3-padding-large w3-hover-black">
