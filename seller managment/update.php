...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    if (empty($Sellername) || empty($Phone_no) || empty($email) || empty($ownerNIC) || empty($Businessregistration_no) || empty($warehouse_address) || empty($New_Password) || empty($ShopLink)) {
        ...
        $sql = "UPDATE seller SET Sellername='$Sellername', Phone_no='$Phone_no', email='$email', ownerNIC='$ownerNIC', Businessregistration_no='$Businessregistration_no', warehouse_address='$warehouse_address', New_Password='$New_Password', ShopLink='$ShopLink' WHERE SellerID='$SellerID'";
...
<ul>
        ...
        <li><a class="active" href="update.php"><h7>Update seller Page</h7></a></li>
